...
class ConnectionSettings extends CWizardStep
{
	...
	function ShowStep()
	{
		...
		$this->content .= '<tr style="height:150px;"><td>';		
		$this->content .= GetMessage("URL").": </td><td>".$this->ShowInputField("text", "site", Array("size" => "40"))."<br/>";
                $this->content .= '</td></tr>';	
                
		$this->content .= '<tr><td>';		
		$this->content .= GetMessage("NEW_URL").": </td><td>".$this->ShowInputField("text", "newurl", Array("size" => "40"))."<br/>";
                $this->content .= '</td></tr>';	
...
class StartMigration extends CWizardStep
{
	...
	function ShowStep()
	{
		...
		$arResult["newurl"] = $wizard->GetVar("newurl");
