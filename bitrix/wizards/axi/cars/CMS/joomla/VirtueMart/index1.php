...
$query = "SELECT "
        . "mf_category_id as XML_ID, "
        . "mf_category_name as NAME, "
        . "mf_category_desc as DETAIL_TEXT "
        . "FROM `".$arResult["prefix"]."vm_manufacturer_category`";
...
$query = "SELECT "
        . "manufacturer_id as XML_ID, "
        . "mf_name as NAME, "
        . "mf_desc as DETAIL_TEXT, "
        . "mf_category_id as IBLOCK_SECTION_ID, "
        . "mf_url as PROPERTY_URL, "
        . "mf_email as PROPERTY_EMAIL FROM `".$arResult["prefix"]."vm_manufacturer`";
$result = mysql_query($query, $link);
while( $arItem = mysql_fetch_assoc($result) )
{
