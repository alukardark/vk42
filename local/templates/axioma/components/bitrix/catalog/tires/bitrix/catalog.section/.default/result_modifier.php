...
foreach ($arResult['ITEMS'] as &$arItem)
{
    ...
    $arItem['DETAIL_BIG']     = \CPic::getDetailSrc($arItem, 1920, 1920, BX_RESIZE_IMAGE_PROPORTIONAL_ALT, false, 95, true);
    $arItem['DETAIL_RESIZED'] = \CPic::getDetailSrc($arItem, 500, 500, BX_RESIZE_IMAGE_PROPORTIONAL_ALT, false, 85, true);
}
...
foreach ($arResult['ITEMS'] as $key => &$arItem)
{
    ...
    if (HIDE_NULL && empty($arItem["REAL_AMOUNT"]))
    {
...
$arResult["NavRecordCount"] = $obNavResult->nSelectedCount;
$arResult["nSelectedCount"] = $obNavResult->nSelectedCount;
